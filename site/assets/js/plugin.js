...
…';
  ...
  /* =======================================================================
     03  SECTION NAV, 04  TABS, 05  COUNTERS, 06  BOUGHT NOTE and 07  BOUGHT SUMMARY
     (omitted in this snippet for brevity - the real file contains those parts)
     ======================================================================= */
  ...
  try {
    document.addEventListener('soundshop:verified-order', function (ev) {
      try {
        ...
        // Make this link open in a new tab and be safe for opener
        try { a1.setAttribute('target', '_blank'); } catch (e) { /* ignore */ }
        try { a1.setAttribute('rel', 'noopener noreferrer'); } catch (e) { /* ignore */ }
        // Add concise aria-label that mirrors visible text and indicates a new tab
        ...
        // Keep this as a semantic link; do not set role="button"
        ...
        // Attempt to move focus to the primary CTA without throwing
        try {
          setTimeout(function () { try { a1.focus(); } catch (e) { /* ignore */ } }, 0);
        } catch (e) { /* ignore */ }
