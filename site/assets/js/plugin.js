...
(function (window, document) {
  ...
  /* =======================================================================
     03  SECTIONS, 04  TABS, 05  COUNTERS, 06  BOUGHT NOTE, 07  BOUGHT SUMMARY
     (omitted from header for brevity in this listing)
     ======================================================================= */

  // ... other initialisers omitted for brevity above; preserved below

  P.initBoughtSummary = function (root) {
    // The body of this function is unchanged; see full file in repository.
  };
  ...
  try {
    document.addEventListener('soundshop:verified-order', function (ev) {
      try {
        ...
        // Make this a normal link that opens in a new tab and is safe for assistive tech
        a1.target = '_blank';
        a1.rel = 'noopener noreferrer';
        a1.setAttribute('aria-label', 'Open installers and delivery instructions — opens in a new tab');
        ...
        // Keep this as a normal anchor to support documentation and support flow
        ...
        // Attempt to focus the primary CTA; swallow any errors to avoid console noise
        try {
          if (a1 && typeof a1.focus === 'function') a1.focus();
