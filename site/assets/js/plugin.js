...
(function (window, document) {
  ...
  /* =======================================================================
     03..07  (other features omitted in this excerpt re-run are unchanged)
     ======================================================================= */
  ...
  try {
    document.addEventListener('soundshop:verified-order', function (ev) {
      try {
        ...
        // Open in a new tab safely for users who expect the docs to appear separately
        try { a1.target = '_blank'; a1.rel = 'noopener noreferrer'; } catch (e) { /* ignore */ }
        ...
        try { a2.target = '_blank'; a2.rel = 'noopener noreferrer'; } catch (e) { /* ignore */ }

        c.appendChild(a1);
        c.appendChild(a2);

        // Add a visually-hidden polite live region announcing the CTA availability.
        try {
          var statusSpan = document.createElement('span');
          statusSpan.setAttribute('aria-live', 'polite');
          // Inline visually-hidden styles so no extra CSS is required.
          ...
          statusSpan.textContent = 'Installers and delivery instructions are available in a new tab.';
        ...
        // Best-effort: move keyboard focus to the primary CTA for discoverability
